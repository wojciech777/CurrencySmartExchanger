...
class MyTestCase(unittest.TestCase):
    ...
    def test_number_of_added_currencies(self):
        currency = CurrencyBuilder().add_currency("euro", 123).add_currency("dollar", 321).build()
    ...
    def test_returned_dictionary(self):
        currency = CurrencyBuilder().set_name("adam").add_currency("euro", 123).add_currency("euro",
                                                                                             124).build()
        self.assertEqual(124, currency.get_all_related_currencies_as_list()[0].get_value())
    ...
    def test_setting_same_name_twice(self):
        currency = CurrencyBuilder().set_name("wojtek").set_name("wojtek").add_currency("euro", 123).add_currency(
            "euro",
            124).build()
        self.assertEqual("wojtek", currency.get_name())
